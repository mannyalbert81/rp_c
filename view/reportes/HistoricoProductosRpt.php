...
$template = file_get_contents('view/reportes/template/HistoricoProductos.html');
...
$stylesheet = file_get_contents('view/reportes/template/HistoricoProductos.css'); // la ruta a tu css
