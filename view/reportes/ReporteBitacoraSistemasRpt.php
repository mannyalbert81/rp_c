...
$template = file_get_contents('view/reportes/template/ReporteBitacoraSistemas.html');
...
$stylesheet = file_get_contents('view/reportes/template/ReporteBitacoraSistemas.css');// la ruta a tu css
