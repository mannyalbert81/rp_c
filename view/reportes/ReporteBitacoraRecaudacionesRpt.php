...
$template = file_get_contents('view/reportes/template/ReporteBitacoraRecaudaciones.html');
...
$stylesheet = file_get_contents('view/reportes/template/ReporteBitacoraRecaudaciones.css');// la ruta a tu css
