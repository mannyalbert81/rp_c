...
class RecaudacionController extends ControladorBase{
	...
	public function MostrarSolicitudesAportes(){
	    ...
	    if( $_SERVER['REQUEST_METHOD'] == "GET" ){
	        ...
	        if( isset($_GET['metodo']) && $_GET['metodo'] == "BUSCAR" ){
	            ...
	            if( !empty($rsConsulta1) ){
	                ...
	                $columnas2 = " 1 ";
	                $tablas2   = " solicitud_valor_aportacion aa
	                   INNER JOIN estado bb ON bb.id_estado = bb.id_estado";
	                $where2    = " bb.nombre_estado <> 'APROBADO GERENTE' AND aa.id_participes = $_id_participes";
