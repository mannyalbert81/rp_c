...
$template = file_get_contents('view/reportes/template/ReporteActaLiquidacion.html');
...
$stylesheet = file_get_contents('view/reportes/template/ReporteActaLiquidacion.css'); // la ruta a tu css
