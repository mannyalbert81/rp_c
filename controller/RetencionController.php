 ...
 public function Reporte_Retencion()
    {
        ...
        foreach ($retencion_detalle as $res){
        	...
        	if($res->impuesto_codigoretencion=='323'){
        	    
        	    $html.='<td>RENDIMIENTOS IFIS</td>';
        	}else{
    ...
    public function Enviar_Correo(){
    	...
    	if(isset($_GET["id_tri_retenciones"])){
            ...
            if(!empty($reultRet)){
            	...
            	$camino_nombre_xml = "DOCUMENTOSELECTRONICOS/docAutorizados/".$infotributaria_claveacceso. ".XML";
        	...
        	*/
        	...
        	if(!empty($reultSet)){
    			...
    			$mail->Password = '@Soporte2020';					//Sets SMTP password //ant pass -- 'info/*-+2018'
    			$mail->SMTPSecure = '';					
    			$mail->CharSet = 'UTF-8';
    			...
    			$mail->Subject = 'Documento Electrónico Generado';			//Sets the Subject of the message
    ...
    public function EnviarCorreoMasivo(){
       ...
       session_start();
        ...
        $col1="id_tri_retenciones";
        $tab1="public.tri_retenciones";
        $where1="enviado_correo_electronico ='FALSE' and  date(creado) = '2020-03-10'";
        $id1="id_tri_retenciones";
        $limit1 = "limit 2";
        
        $resultSet1=$retenciones->getCondicionesPag($col1, $tab1, $where1, $id1, $limit1);
        ...
        if(!empty($resultSet1)){
            ...
            foreach ($resultSet1 as $value) {
                ...
                $id_tri_retenciones=$value->id_tri_retenciones;
                
                
                $this->termina_masivo($id_tri_retenciones);
    ...
    public function termina_masivo($id_tri_retenciones){
