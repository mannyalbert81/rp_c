...
$template = file_get_contents('view/reportes/template/ReporteCesantia.html');
...
$stylesheet = file_get_contents('view/reportes/template/reporteCesantia.css');// la ruta a tu css
