...
$template = file_get_contents('view/reportes/template/ReporteBitacoraTesoreria.html');
...
$stylesheet = file_get_contents('view/reportes/template/ReporteBitacoraTesoreria.css');// la ruta a tu css
