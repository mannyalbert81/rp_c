...
$template = file_get_contents('view/reportes/template/ReporteHojaLiquidacion.html');
...
$stylesheet = file_get_contents('view/reportes/template/ReporteHojaLiquidacion.css'); // la ruta a tu css
