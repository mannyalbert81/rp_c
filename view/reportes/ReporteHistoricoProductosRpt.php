...
$template = file_get_contents('view/reportes/template/ReporteHistoricoProductos.html');
...
$stylesheet = file_get_contents('view/reportes/template/ReporteHistoricoProductos.css'); // la ruta a tu css
