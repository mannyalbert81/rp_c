       ...
       <li class="header">MAIN NAVIGATION</li>
        ...
        <li class="treeview"  style="<?php echo getcontrolador("ReportesInventario",$controladores) ?>"  >
          ...
          <ul class="treeview-menu">
            ...
            <li style="<?php echo getcontrolador("HistoricoProducto",$controladores) ?>"><a href="index.php?controller=HistoricoProducto&action=index2"><i class="fa fa-circle-o"></i>Historico de Productos</a></li>
		 	</ul>
        </li>
       </ul>
      </li>
     ...
     <ul class="treeview-menu">
      ...
      <li class="treeview"  style="<?php echo getcontrolador("MenuTesoreria",$controladores) ?>"  >
        ...
        <li class="treeview"  style="<?php echo getcontrolador("ReportesCore",$controladores) ?>"  >
          ...
          <li style="<?php echo getcontrolador("ConsultaRegistroTresCuotas",$controladores) ?>"><a href="index.php?controller=ConsultaRegistroTresCuotas&action=index"><i class="fa fa-circle-o"></i>Registro de Cuotas</a></li>
