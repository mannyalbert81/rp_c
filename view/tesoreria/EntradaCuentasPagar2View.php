  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="box box-primary">
        ...
        <form id="frm_cuentas_pagar2" action="<?php echo $helper->url("CuentasPagar","CuentasPagarIndex"); ?>" method="post" enctype="multipart/form-data"  class="form form-horizontal col-lg-12 col-md-12 col-xs-12">
...
<script type="text/javascript" src="view/tesoreria/js/wizardCuentasPagar.js?0.00"></script>
