...
class BuscarParticipesController extends ControladorBase{
    ...
    public function ActualizarInfoParticipe()
    {
        session_start();
        ...
        $id_participes=$id_participes[0]->id_participe;
        ...
        $colval = "fecha_nacimiento_participes='".$resultSet[0]->fecha_nacimiento_datos_personales."',
                   ...
                   nombre_conyugue_participes='".$resultSet[0]->nombres_conyuge."'
                   apellido_esposa_participes='".$resultSet[0]->apellidos_conyuge."',
                   cedula_conyugue_participes='".$resultSet[0]->numero_cedula_conyuge."',
        ...
        $colval = "parroquia_participes_informacion='".$nombre_parroquias."',
                    ...
                    anios_residencia_participes_informacion_adicional='".$resultSet[0]->tiempo_residencia_vivienda."',
        ...
        if($resultSet[0]->tipo_pago_cuenta_bancaria=='Depósito')
        {
            
        }
        
        echo $direccion_participe;  
    }
