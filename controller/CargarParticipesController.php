...
class CargarParticipesController extends ControladorBase{
    ...
    public function index()
    {
        ...
        $cedula = $_GET['cedula'];                
        $cedula =  $creditos->desencriptar($creditos->urlDecodicada($cedula ));
    ...
    public function InfoSolicitud_carga()
    {
        session_start();
    ...
    public function BuscarParticipe_carga()
    {
        session_start();
    ...
    public function AportesParticipe_carga()
    {
        session_start();
    ...
    public function paginate_aportes_carga($reload, $page, $tpages, $adjacents,$id_participe,$funcion='') {
    ...
    public function CreditosActivosParticipe_carga()
    {
        session_start();
        $id_participe=$_POST['id_participe'];
        $html="";
   ...
   <td id="cedula_credito"><font size="3"> Cédula : '.$infoParticipe[0]->cedula_participes.'</font></td>
    ...
    public function obtenerTipoCredito()
    {
        ...
        //$where = "core_tipo_creditos.id_estatus=1 AND estado.nombre_estado='ACTIVO' AND core_tipo_creditos.codigo_tipo_creditos IN ('ORD','EME')  ";
    ...
    public function obtenerSimulacionCredito()
    {
        ...
        if ($tipo_credito == "PH" && $id_solicitud != 0)
        {
            ...
            $where = "id_solicitud_credito=" . $id_solicitud;
            $avaluo_credito = $cuotas->getCondicionesSinOrden($columnas, $tablas, $where, "");
            $avaluo_credito = (!empty($avaluo_credito) ? $avaluo_credito[0]->valor_avaluo_core_documentos_hipotecario : 0);
...
VALUES( $id_creditos, $valor_retencion)";
    ...
    /*********************************************** CREDITOS PARTICIPES CONTROLLER *****************************/
    ...
    public function InformacionCrediticiaParticipe()
    {
        ...
        try {
            ...
            $icon = ( $infoParticipe[0]->id_genero_participes == "1") ? '<i class="fa fa-male fa-2x"></i>' : '<i class="fa fa-female fa-2x" ></i>';
            
            $html = '<div id="info_participe_solicitud" class="row small-box bg-olive">
                    <h3 class="titulo">DATOS PERSONALES</h3>
                    <div class="col-md-6 col-lg-6">
                    <div class="box-footer no-padding bg-olive">
                        <div class="bio-row"><p> '.$icon.' &nbsp;&nbsp; '. $data['nombre_participe_credito'] . '</p></div>
