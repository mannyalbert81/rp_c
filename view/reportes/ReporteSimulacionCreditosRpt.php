...
$template = file_get_contents('view/reportes/template/ReporteSimulacionCreditos.html');
...
$diccionario = ( isset( $dictionary ) ) ? $dictionary : null;
...
$stylesheet = file_get_contents('view/reportes/template/ReporteSimulacionCreditos.css');// la ruta a tu css
