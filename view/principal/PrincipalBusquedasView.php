            			...
            			<div class="form-group ">
                    		...
                    		<div class="form-group-sm">           
                        	 ...
                        	 <div id="pnlResultadosPrestamos" class="row hidden">
                    			...
                    			<form id="frm_busqueda_principal" action="<?php echo $helper->url("PrincipalPrestamos","index"); ?>" method="post" >
                 			...
                 			<div id="pnlBusqueda" class="row">
                				...
                				<div class="panel panel-default">
                          		...
                          		<table id="tblBusquedaPrincipal" class="table">   
                          			...
                          			<tbody>
                              		<tr>
                                  		<td><label>Identificacion del Afiliado:</label></td>
                                  		<td><input type="text" class="form-control" id="txtIdentificacion"></td>                     		
                              		</tr>
                              		<tr>
                                  		<td><label>Nombres del Afiliado:</label></td>
                                  		<td><input type="text" class="form-control" id="txtNombres"></td>
                              		</tr>
                              		<tr>
                                  		<td><label>Apellidos del Afiliado:</label></td>
                                  		<td><input type="text" class="form-control" id="txtApellidos"></td>
                              		</tr> 
                              		<tr>
                                  		<td><label>Tipo Préstamo:</label></td>
