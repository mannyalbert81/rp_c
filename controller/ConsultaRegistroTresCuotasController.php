	...
	public function ConsultaRegistroTresCuotas(){
	    ...
	    registro_tres_cuotas.estado_registro_tres_cuotas,
	    ...
	    $where = "core_participes.id_participes = registro_tres_cuotas.id_participes AND
	    core_creditos.id_creditos = registro_tres_cuotas.id_creditos AND
	    core_tipo_creditos.id_tipo_creditos = core_creditos.id_tipo_creditos AND registro_tres_cuotas.estado_registro_tres_cuotas = 'FALSE'";
	    ...
	    if($action == 'ajax')
	    {
	        ...
	        if($cantidadResult > 0)
	        {
	            ...
	            $html.='<th style="text-align: center;  font-size: 12px;">Aprobar</th>';
	            ...
	            foreach ($resultSet as $res)
	            {
	                ...
	                if($res->estado_registro_tres_cuotas == "t"){
	                    
	                    $estado ="APROBADO";
	                    
	                }elseif($res->estado_registro_tres_cuotas == "f"){
	                ...
	                $html.='<td style="font-size: 14px;"><a onclick="AprobarRegistro('.$res->id_registro_tres_cuotas.')"   href="#" class="btn btn-success" style="font-size:65%;"data-toggle="tooltip" title="Aprobar"><i class="glyphicon glyphicon-plus"></i></a></td>';
	...
	public function ConsultaRegistroTresCuotasAprobado(){
	    ...
	    $where = "core_participes.id_participes = registro_tres_cuotas.id_participes AND
	    core_creditos.id_creditos = registro_tres_cuotas.id_creditos AND
	    core_tipo_creditos.id_tipo_creditos = core_creditos.id_tipo_creditos AND registro_tres_cuotas.estado_registro_tres_cuotas = 'TRUE'";
	...
	public function AprobarRegistro(){
	    ...
	    if (!empty($resultPer)){
	        ...
	        if(isset($_POST["id_registro_tres_cuotas"])){
	            ...
	            $columna = "estado_registro_tres_cuotas = 'TRUE'";
