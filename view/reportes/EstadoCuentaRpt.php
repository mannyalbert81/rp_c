...
$template = file_get_contents('view/reportes/template/EstadoCuenta.html');
...
$stylesheet = file_get_contents('view/reportes/template/EstadoCuenta.css'); // la ruta a tu css
