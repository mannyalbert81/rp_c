...
class BitacoraActividadesEmpleadosTesoreriaController extends ControladorBase{
    ...
    public function index(){
        ...
        $bitacora_tesoreria = new CreditosModel();
        ...
        $nombre_controladores = "BitacoraActividadesEmpleadosTesoreria";
        $id_rol= $_SESSION['id_rol'];
        $resultPer = $bitacora_tesoreria->getPermisosVer("   controladores.nombre_controladores = '$nombre_controladores' AND permisos_rol.id_rol = '$id_rol' " );
        ...
        $rsEmpleados    = $bitacora_tesoreria->getCondicionesSinOrden( $col1, $tab1, $whe1, "");
        $desde = '8:00:00';
        $hasta = '16:45:00';
        
        
        $this->view_Core("BitacoraActividadesEmpleadosTesoreria",array(
    ...
    public function InsertaBitacoraTesoreria(){
         session_start();
         ...
         $bitacora_tesoreria = new CreditosModel();
            ...
            $_biess = (isset($_POST["biess"])) ? $_POST["biess"] : "" ;
            $_sb = (isset($_POST["sb"])) ? $_POST["sb"] : "" ;
            ...
            $_id_bitacora_actividades_empleados_tesoreria = (isset($_POST["id_bitacora_actividades_empleados_tesoreria"])) ? $_POST["id_bitacora_actividades_empleados_tesoreria"] : 0 ;
            
            $funcion = "ins_core_bitacora_actividades_empleados_tesoreria";
            $respuesta = 0 ;
            $mensaje = "";
            
             
            if($_id_bitacora_actividades_empleados_tesoreria == 0){
                ...
                $parametros = "'$_fecha_registro',
                               ...
                               '$_otras_actividades',
                               '$_motivo_atencion',
                               '$_id_bitacora_actividades_empleados_tesoreria'";
                                $bitacora_tesoreria->setFuncion($funcion);
                                $bitacora_tesoreria->setParametros($parametros);
                
                //echo "SELECT ". $funcion." ( ".$parametros." )"; die();
                                $resultado = $bitacora_tesoreria->llamafuncionPG();
            ...
            }elseif ($_id_bitacora_actividades_empleados_tesoreria > 0){
    ...
    public function editBitacoraTesoreria(){
        
        session_start();
        $bitacora_tesoreria = new CreditosModel();
        $nombre_controladores = "BitacoraActividadesEmpleadosTesoreria";
        $id_rol= $_SESSION['id_rol'];
        $resultPer = $bitacora_tesoreria->getPermisosEditar("controladores.nombre_controladores = '$nombre_controladores' AND permisos_rol.id_rol = '$id_rol' " );
        
        if (!empty($resultPer))
        {
            
            
            if(isset($_POST["id_bitacora_actividades_empleados_tesoreria"])){
                
                $id_bitacora_actividades_empleados_tesoreria = (int)$_POST["id_bitacora_actividades_empleados_tesoreria"];
                
                $query = "SELECT a.*, b.cedula_participes, b.nombres_participes FROM core_bitacora_actividades_empleados_tesoreria a
                    left join (
                ...
                WHERE a.id_bitacora_actividades_empleados_tesoreria = $id_bitacora_actividades_empleados_tesoreria";
                
                $resultado  = $bitacora_tesoreria->enviaquery($query);
    ...
    public function delBitacoraTesoreria(){
        
        session_start();
        $bitacora_tesoreria = new BitacoraTesoreriaModel();
        $nombre_controladores = "BitacoraActividadesEmpleadosTesoreria";
        $id_rol= $_SESSION['id_rol'];
        $resultPer = $bitacora_tesoreria->getPermisosBorrar("  controladores.nombre_controladores = '$nombre_controladores' AND permisos_rol.id_rol = '$id_rol' " );
        ...
        if (!empty($resultPer)){
            ...
            if(isset($_POST["id_bitacora_actividades_empleados_tesoreria"])){
                ...
                $resultado  = $bitacora_tesoreria->eliminarBy("id_bitacora_actividades_empleados_tesoreria ",$id_bitacora_actividades_empleados_tesoreria);
    ...
    public function consultaBitacoraTesoreria(){
        ...
        $where_to="";
        $columnas ="a.id_bitacora_actividades_empleados_tesoreria,
                    a.fecha_registro,
                    a.desde,
                    a.hasta,
                    a.id_empleados,
                    ...
                    a.otras_actividades,
                    a.motivo_atencion";
        $tablas  = "core_bitacora_actividades_empleados_tesoreria a
        ...
        $id      = "a.id_bitacora_actividades_empleados_tesoreria";
        ...
        if($action == 'ajax')
        {
            ...
            $where_to=$where;
            $html="";
            $resultSet=$bitacora_tesoreria->getCantidad("*", $tablas, $where_to);
            ...
            $resultSet=$bitacora_tesoreria->getCondicionesPagDesc($columnas, $tablas, $where_to, $id, $limit);
            ...
            if($cantidadResult > 0)
            {
                ...
                foreach ($resultSet as $res)
                {
                    ...
                    $html.='<td style="font-size: 18px;">
                            <a onclick="editBitacoraTesoreria('.$res->id_bitacora_actividades_empleados_tesoreria.')" href="#" class="btn btn-warning" style="font-size:65%;"data-toggle="tooltip" title="Editar"><i class="glyphicon glyphicon-edit"></i></a></td>';
                    $html.='<td style="font-size: 18px;">
                            <a onclick="delBitacoraTesoreria('.$res->id_bitacora_actividades_empleados_tesoreria.')"   href="#" class="btn btn-danger" style="font-size:65%;"data-toggle="tooltip" title="Eliminar"><i class="glyphicon glyphicon-trash"></i></a></td>';
                ...
                $html.=''. $this->paginate("index.php", $page, $total_pages, $adjacents,"consultaBitacoraTesoreria").'';
                $html.='</div>';
    ...
    public function ReporteBitacoraTesoreria(){
        ...
        if($action == 'ajax')
        {
            ...
            $where_to=$where;
            $bitacora_detalle=$bitacora_tesoreria->getCondiciones($columnas, $tablas, $where_to, $id );
            ...
            $this->verReporte("ReporteBitacoraTesoreria", array('datos_reporte'=>$datos_reporte ));
