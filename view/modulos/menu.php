   ...
   <ul class="sidebar-menu" data-widget="tree">
       <li class="header">MAIN NAVIGATION</li>
        ...
        <li class="treeview"  style="<?php echo getcontrolador("AdministracionContabilidad",$controladores) ?>"  >
          ...
          <ul class="treeview-menu">
            <li style="<?php echo getcontrolador("Productos",$controladores) ?>"><a href="index.php?controller=Productos&action=consulta_productos"><i class="fa fa-circle-o"></i> Consulta Productos</a></li>
		  </ul>
        </li>
       </ul>
      </li>
