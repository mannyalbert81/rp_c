...
$template = file_get_contents('view/reportes/template/ReporteDescuentos.html');
...
$stylesheet = file_get_contents('view/reportes/template/ReporteDescuentos.css');// la ruta a tu css
