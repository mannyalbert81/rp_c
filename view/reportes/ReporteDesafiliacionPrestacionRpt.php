...
$template = file_get_contents('view/reportes/template/ReporteDesafiliacionPrestacion.html');
...
$stylesheet = file_get_contents('view/reportes/template/reporteDesafiliacionPrestacion.css');// la ruta a tu css
