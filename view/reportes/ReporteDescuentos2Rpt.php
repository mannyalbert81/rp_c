...
$template = file_get_contents('view/reportes/template/ReporteDescuentos2.html');
...
$stylesheet = file_get_contents('view/reportes/template/ReporteDescuentos2.css');// la ruta a tu css
