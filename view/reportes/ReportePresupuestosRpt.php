...
$template = file_get_contents('view/reportes/template/ReportePresupuestos.html');
...
$stylesheet = file_get_contents('view/reportes/template/ReportePresupuestos.css'); // la ruta a tu css
