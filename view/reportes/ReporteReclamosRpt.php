...
$template = file_get_contents('view/reportes/template/ReporteReclamos.html');
...
$stylesheet = file_get_contents('view/reportes/template/ReporteReclamos.css'); // la ruta a tu css
