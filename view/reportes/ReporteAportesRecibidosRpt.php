...
$template = file_get_contents('view/reportes/template/ReporteAportesRecibidos.html');
...
$stylesheet = file_get_contents('view/reportes/template/ReporteAportesRecibidos.css'); // la ruta a tu css
