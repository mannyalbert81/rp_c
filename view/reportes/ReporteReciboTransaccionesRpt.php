...
$header = file_get_contents('view/reportes/template/CabeceraRecibo.html');
$template = file_get_contents('view/reportes/template/ReporteReciboTransacciones.html');
...
$stylesheet = file_get_contents('view/reportes/template/ReporteReciboTransacciones.css');// la ruta a tu css
