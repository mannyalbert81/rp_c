...
$template = file_get_contents('view/reportes/template/ReporteKardexSocios.html');
...
$stylesheet = file_get_contents('view/reportes/template/ReporteKardexSocios.css'); // la ruta a tu css
