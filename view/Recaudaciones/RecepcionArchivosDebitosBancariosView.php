  ...
  <section class="content-header">
    ...
    <section class="content">
     ...
     <div class="box-header">
          <h3 class="box-title">Debitos Bancarios</h3>
  		...
  		<div class="box-body">
			...
			<form id="frm_carga_recaudaciones" action="<?php echo $helper->url("RecepcionArchivosDebitosBancarios","InsertaRecepcionArchivosDebitosBancarios"); ?>" method="post" class="col-lg-12 col-md-12 col-xs-12">
            ...
            <div class="row">        	
        		...
        		<div class="row">        	
        			...
        			<div class="col-lg-6 col-md-6 col-xs-12">        		
            			<div class="form-group "> 
                			 <div class="form-group-sm">
                				<label for="nombre_carga_recaudaciones" class="col-sm-4 control-label" >Fecha Contable:</label>
                				<div class="col-sm-8">                					
                             	   <input type="date" name="nombre_carga_recaudaciones" id="nombre_carga_recaudaciones" value=""  class="form-control"/>
                             	</div>
                			 </div>        			 
            			</div>
    				</div>
            	...
            	<div class="row">        	
        			<div class="col-lg-6 col-md-6 col-xs-12">        		
            			<div class="form-group "> 
                			 <div class="form-group-sm">
                				<label for="nombre_carga_recaudaciones" class="col-sm-4 control-label" >Obeservaciones:</label>
                				<div class="col-sm-8">                					
                             	   <input type="text" name="nombre_carga_recaudaciones" id="nombre_carga_recaudaciones" value=""  class="form-control"/>
                             	</div>
                			 </div>        			 
            			</div>
    				</div>
...
<!-- END MODAL DESCUENTOS CREDITOS SIN APORTES -->
   ...
   <script src="view/Recaudaciones/js/RecepcionArchivosDebitosBancarios.js?0.01"></script> 
