...
$template = file_get_contents('view/reportes/template/ReporteDescuentosRecibidos.html');
...
$stylesheet = file_get_contents('view/reportes/template/ReporteDescuentosRecibidos.css'); // la ruta a tu css
