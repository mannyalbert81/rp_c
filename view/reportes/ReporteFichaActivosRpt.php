...
$template = file_get_contents('view/reportes/template/ReporteFichaActivos.html');
...
$stylesheet = file_get_contents('view/reportes/template/ReporteFichaActivos.css'); // la ruta a tu css
