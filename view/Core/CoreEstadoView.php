  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="box box-primary">
        ...
        <form action="<?php echo $helper->url("CoreEstado","InsertaEstado"); ?>" method="post" enctype="multipart/form-data"  class="col-lg-12 col-md-12 col-xs-12">
                                ...
                                <label for="descripcion_estado" class="control-label">Descripción</label>
                                <input type="text" class="form-control" id="descripcion_estado" name="descripcion_estado" value="<?php echo $resEdit->descripcion_estado; ?>"  placeholder="Nombre Descripción">
                                <div id="mensaje_descripcion_estado" class="errores"></div>
                                </div>
                        		</div>  
                        		...
                        		<div class="form-group">
                                                          ...
                                                          <select name="id_estatus" id="id_estatus"  class="form-control">
                                                            <option value="0" selected="selected">--Seleccione--</option>
																<?php foreach($resultEstatu as $resEstatu) {?>
				 												<option value="<?php echo $resEstatu->id_estatus; ?>" <?php if ($resEstatu->id_estatus == $resEdit->id_estatus )  echo  ' selected="selected" '  ;  ?> ><?php echo $resEstatu->nombre_estatus; ?> </option>
													            <?php } ?>
								    					  </select>
		                    ...
		                    <div class="row">
                       		<div class="col-xs-12 col-md-3 col-md-3 ">
                        	    <div class="form-group">
                                <label for="descripcion_estado" class="control-label">Descripción</label>
                                <input type="text" class="form-control" id="descripcion_estado" name="descripcion_estado" value=""  placeholder="Nombre Descripción">
                                <div id="mensaje_descripcion_estado" class="errores"></div>
                                </div>
                        		</div> 	
                        	  ...
                        	  <div class="col-xs-12 col-md-3 col-md-3">
                        		    <div class="form-group">
                                                          ...
                                                          <select name="id_estatus" id="id_estatus"  class="form-control">
                                                            <option value="0" selected="selected">--Seleccione--</option>
																<?php foreach($resultEstatu as $resEstatu) {?>
				 												<option value="<?php echo $resEstatu->id_estatus; ?>"  ><?php echo $resEstatu->nombre_estatus; ?> </option>
													            <?php } ?>
								    					  </select>
		   		   										   <div id="mensaje_id_estatus" class="errores"></div>
                                    </div>
                    		    ...
                    		    <div class="form-group">
                                                      ...
                                                      <a href="index.php?controller=CoreEstado&action=index" class="btn btn-primary"><i class='glyphicon glyphicon-remove'></i> Cancelar</a>
        	                    </div>
                    		    </div>
                    		    </div>
                      ...
                      <tbody>
    					<?php $i=0;?>
    						...
    						<?php $i++;?>
            	        		<tr>
            	                   <td > <?php echo $i; ?>  </td>
            	                   <td > <?php echo $res->descripcion_estado; ?>     </td>
            		               <td > <?php echo $res->nombre_estatus; ?>     </td> 
            		                
            		           	   <td>
            			           		<div class="right">
            			                    <a href="<?php echo $helper->url("CoreEstado","index"); ?>&id_estado=<?php echo $res->id_estado; ?>" class="btn btn-warning" style="font-size:65%;" data-toggle="tooltip" title="Editar"><i class='glyphicon glyphicon-edit'></i></a>
            			                </div>
            			            
            			             </td>
            			             <td>   
            			                	<div class="right">
            			                    <a href="<?php echo $helper->url("CoreEstado","borrarId"); ?>&id_estado=<?php echo $res->id_estado; ?>" class="btn btn-danger" style="font-size:65%;" data-toggle="tooltip" title="Eliminar"><i class="glyphicon glyphicon-trash"></i></a>
            			                </div>
